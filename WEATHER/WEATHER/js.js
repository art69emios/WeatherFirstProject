...
fetch('http://api.openweathermap.org/data/2.5/weather?id=703448&appid=bf35cac91880cb98375230fb443a116f&units=metric')
...
let ftch = fetch('https://api.openweathermap.org/data/2.5/onecall?lat=50.4333&lon=30.5167&exclude=hourly,minutely&appid=bf35cac91880cb98375230fb443a116f&units=metric')
...
fetch('http://api.openweathermap.org/data/2.5/weather?id=2643743&appid=bf35cac91880cb98375230fb443a116f&units=metric')
   .then(resObj => resObj.json())
   .then(res => {
      console.log(res);
...
fetch('http://api.openweathermap.org/data/2.5/weather?id=5128638&appid=bf35cac91880cb98375230fb443a116f&units=metric')
   .then(resObj => resObj.json())
   .then(res => {
      console.log(res);
